...
#-Admin create quiz
    ...
    def Create_Quiz(self):
        how_many_topic=int(input("How Many Topic do You Want to Add in Quiz?: "))
        for i in range(1,how_many_topic+1):
            ...
            for j in range(1,how_many_question+1):
                ...
                d_level[j]=input(" Type of difficulty?: ")
...
#View Quize function start#
    ...
    def View_Quizzes(self):
        if self.MCQ=={}:
            ...
            print("If You Are User Please try After Some Time\n\nIf You Are a Admin Please Add Quiz First")
        else:
...
#Edit Quiz function start
    ...
    def Edit_Quiz(self):
        if self.MCQ=={}:
            print(" No Quiz Available plz add quiz")
            ...
            if edit==1:
                ...
                for type_of_sub in self.MCQ:
                    ...
                    for question_no in self.MCQ:
                        ...
                        question_counter+=1
                    print()
                topic_no=int(input("\n plz Enter the topic no you want to edit"))
...
#Create Topic function start 
    ...
    def Create_Topic(self):
        ...
        how_many_topic=int(input("\n plz Enter the no of topic you want to create: "))
    ...
    def user_test(self):
        ...
        if self.MCQ=={}:
            ...
            for question_no in range(1,len(Admin.MCQ[topic_selection])):
                ...
                print("Plz Choose the correct answer\n")
